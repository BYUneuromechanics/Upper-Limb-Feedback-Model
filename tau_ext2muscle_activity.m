function sys_tau_ext2MA = tau_ext2muscle_activity(posture,fb_mult_P,fb_mult_D,GTO_gain,delay_multiplier)
...
%             sys_DeltaLambda2u_fb.IODelay = CentDelays;
    ...
    % FULL SYSTEM
    sys_uSpindles2MA = feedback(eye(15),sys_GTO*sys_u2f_open); % Negative feedback
    sys_frwrd = sys_uSpindles2MA* ss(sys_DeltaLambda2u_fb) * sys_q2DeltaLambda * sys_tau2q ;
    sys_tau_ext2MA = feedback(sys_frwrd, - sys_f2tau * sys_u2f_open); % Positive feedback
