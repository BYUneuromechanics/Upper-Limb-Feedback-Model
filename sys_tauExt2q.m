...
function [sys_tauExternal2q] = sys_tauExt2q(posture,fb_mult_P,fb_mult_D,GTO_gain,delay_multiplier)%,Proximal_Delay,Distal_Delay)
...
%             sys_DeltaLambda2u_fb.IODelay = CentDelays;
    ...
    % FULL SYSTEM
    sys_fb = sys_f2tau * sys_u2f_closed * ss(sys_DeltaLambda2u_fb) * ss(sys_q2DeltaLambda);
    sys_tauExternal2q = feedback(sys_tau2q, -sys_fb);
